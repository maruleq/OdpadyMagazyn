...
<div class="container pt-5 pb-5 text-center">
    ...
    <h1><?php
        ...
        if($id != '') {
            echo "Edytuj ilość odpadu";
        } else {
            echo "Dodaj ilość odpadu";
        } ?></h1>
        ...
        <div class="col-xs-4 m-auto">
            <form action="" method="post" class="form-horizontal">
                <div class="form-group pt-5 pb-3">
                    ...
                    <label for="text"><h4>Odpad: </h4></label>
...
if (isset($_GET['id'])){
    ...
    if (isset($_POST['submit'])){
        ...
        if (is_numeric($_POST['id'])){
            ...
            if ($ilosc == ''){
                ...
                if ($stmt = $polaczenie->prepare("UPDATE odpad_zb SET ilosc = ? WHERE id = ?")){
        ...
        if (is_numeric($_GET['id']) && $_GET['id'] > 0 ){
            ...
            if ($stmt = $polaczenie->prepare("SELECT `id`, `ilosc` FROM odpad_zb WHERE id = ?")){
    ...
    if (isset($_POST['submit'])){
        ...
        if ($ilosc == ''){
            ...
            if ($stmt = $polaczenie->prepare("INSERT odpad_zb (ilosc) VALUES (?)")){
